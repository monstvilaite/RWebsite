...
![Transmission electron micrograph of intact rotavirus particles [@web]](RotaVaccine\Rota2.PNG){width=300px}
<!--
\begin{figure}[H]
\begin{center}
...
![Schematic representation of the model](RotaVaccine\Rota1.PNG){width=250px}
<!--   
\begin{figure}[H]
\begin{center}
...
![(Baseline) Scenario: No Vaccination](RotaVaccine\IMbV.jpg){width=250px} ![](RotaVaccine\ISbV.jpg){width=250px}

![Scenario 1: 1(a)+2(a)+3(a)](RotaVaccine\IMScenario1.jpg){width=250px} ![](RotaVaccine\ISScenario1.jpg){width=250px}


![Scenario 2: 1(b)+2(a)+3(a)](RotaVaccine\IMScenario2.jpg){width=250px} ![](RotaVaccine\ISScenario2.jpg){width=250px}
